...
Kangaroo provides easy wallet restore functionality for any standard compliant wallet. Users are able to restore wallets that were created in Kangaroo as well as ones created in other non-custodial wallet apps.
